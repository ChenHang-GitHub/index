...
//                                System.out.println("className.methodName()+!!!!"+list);
                              Post p =  (Post)request.getAttribute("poa");
                                ...
                                %>
                <form action ="Login" method="post">
                    <input type="hidden" name="oper" value="updatePostInfo" />
                    <input type="hidden" name="TypeG" value="<%=p.getPostId()%>" />
                    <div id="tab1" class="tabson">
                        <ul class="forminfo">
                                <h1></h1>
                                <li><label><b>*</b>岗位编码</label><input name="TypeA"    value="<%=p.getPostCode()%>" type="text" readonly="true" class="dfinput" style="width:300px;"/></li>
                            <li><label><b>*</b>岗位名称</label><input name="TypeB"  value="<%=p.getPostName()%>" type="text" class="dfinput" style="width:300px;"/></li>
                            ...
                            <li><label>&nbsp;&nbsp;所在部门<b></b></label>  
                                ...
                                <div class="vocation"  >
                                  ...
                                  <li><label><b>&nbsp;</b>岗位职责</label><input name="TypeF" value="<%=duty%>" type="textarea" class="dfinput" style="width:300px;height: 80px"/></li>
