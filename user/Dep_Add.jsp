...
//                                System.out.println("className.methodName()+!!!!"+list);
                                List<String> list = (List<String>)request.getAttribute("DeIn");
                                System.out.println("className.methodName()He??????"+list.toString());
                                %>
                <form action ="Login" method="post">
                    <input type="hidden" name="oper" value="addDep" />
                    <div id="tab1" class="tabson">
                        <ul class="forminfo">
                            
                   
                                <h1></h1>
                                <li><label><b>*</b>部门编码</label><input name="TypeA"   type="text" required="true" class="dfinput" style="width:300px;"/></li>
                            <li><label><b>*</b>部门名称</label><input name="TypeB"  type="text"  required="true" class="dfinput" style="width:300px;"/></li>
                            ...
                            <li><label>&nbsp;&nbsp;部门负责人<b></b></label>  
                             ...
                             <li><label><b>*</b>部门职责</label><input name="TypeD" type="text" required="true"  class="dfinput" style="width:300px;"/></li>
                                                                       
                            <li><label><b>*</b>上级部门</label><input name="TypeE" type="text" required="true"  class="dfinput" style="width:300px;"/></li>
                            <li><label><b>&nbsp;</b>备注</label><input name="TypeF"  type="text" class="dfinput" style="width:300px;"/></li>
