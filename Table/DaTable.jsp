        ...
        <div class="rightinfo">
            <form action="Classes" method="post">
                ...
                <div class="tools">
                    ...
                    <ul class="toolbar">
                        <li class="click"><span><img src="images/t01.png" /></span>打卡</li>
                        <li>
...
//          User u  =  (User)   hs.getAttribute("user");
                 ...
                 { 
                    ...
                    <tr>
                        <td><input name="chk" id="chk" type="checkbox" value="1" /></td>
                         ...
                         <td><%=Temp.getPName()%></td>
                         <%
                             String subString = String.valueOf(Temp.getPDate()).substring(0,19);
                         %>
                         <td><%=subString%></td>
            ...
            <div class="tip">
                ...
                <div class="tipbtn">
                    <a href="Table/DaAdd.jsp">     <input  type="button"  class="sure" value="确定" />&nbsp;</a>
