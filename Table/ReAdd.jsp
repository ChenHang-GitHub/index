        ...
        <div class="formbody">
            ...
            <div id="usual1" class="usual"> 
                ...
                <form action ="Table" method="post">
                    <input type="hidden" name="oper" value="AddReTable" />
                    <div id="tab1" class="tabson">
                        <ul class="forminfo">
                            <h1></h1>
                            <li><label><b>*</b>补卡人</label><input name="TypeA"   value="<%=u.getUserName()%>"  type="text" readonly="true"  class="dfinput" style="width:300px;"/></li>
                            <li><label><b>*</b>补卡时间</label><input name="TypeB"   value="<%=time%>" type="text"   class="dfinput" style="width:300px;"/></li>
