<%@page import="pojo.RepairCard"%>
<%@page import="pojo.PunchCard"%>
        ...
        <div class="rightinfo">
            <form action="Classes" method="post">
                ...
                <div class="tools">
                    ...
                    <ul class="toolbar">
                        <li class="click"><span><img src="images/t01.png" /></span>补卡</li>
                        <li>
...
//                 List<PunchCard> pl =  (List<PunchCard>) request.getAttribute("pl");
//                 for( PunchCard Temp  : pl)
//                 { 
                   List<RepairCard> rl = (List<RepairCard>)request.getAttribute("rl");
                   for(RepairCard Temp:rl)
                   {
                     %>
                    ...
                    <tr>
                        ...
                        <td><%=Temp.getRId()%></td>    
                         <td><%=Temp.getRno()%></td>    
                         <td><%=Temp.getRName()%></td>
                         <%       String subString = String.valueOf(Temp.getRDate()).substring(0,19); %>
                         <td><%=subString%></td>
            ...
            <div class="tip">
                ...
                <div class="tipbtn">
                    <a href="Table/ReAdd.jsp">     <input  type="button"  class="sure" value="确定" />&nbsp;</a>
