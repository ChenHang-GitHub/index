    ...
    <body>
        ...
        <div class="rightinfo">
            ...
            <table class="tablelist">
                ...
                <%
                    List<Salary> sl  = (List<Salary>)request.getAttribute("sl");
                    for(Salary Temp:sl)
                    {
                %>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><%=Temp.getEDate()%></td>
                        <td></a>
                            <a href="Table?oper=deleteSalary&SId=<%=Temp.getSId()%>" class="tablelink">删除</a></td>
                    </tr> 
                     <%}%>
                </tbody>
            ...
            <div class="pagin">
                <div class="message">共<i class="blue"><%=sl.size()%></i> 条记录</div>
                <ul class="paginList">
            ...
            <div class="tip">
                ...
                <div class="tipbtn">
                    <a href="Salary/salary_Add.jsp">     <input  type="button"  class="sure" value="确定" />&nbsp;</a>
